...
const ForcastGraph = () => {
  ...
  const saveAffiliateMutate = useMutation({
    mutationKey: ["saveAffiliate", affiliate?.id],
  ...
  const handleChangeReferTotal = async (value: number[]) => {
    setReferTotalMonthly(value[0])
    await saveAffiliateResponse()
  }
  const handleChangeReferProject = async (value: number[]) => {
    setAvgNewProjectMonthly(value[0])
    await saveAffiliateResponse()
  }
  const handleChangeExistingProjects = async (value: number[]) => {
            ...
            <div className='px-10 md:px-0 my-4 md:my-0 md:w-1/4'>
              <div className="flex flex-col space-y-4">
                ...
                <div className='flex flex-col space-y-3'>
                      ...
                      <div>
                        <TooltipProvider>
                          <Tooltip>
                            ...
                            <TooltipContent>
                              <p>A number between 1 and 10,000</p>
                            </TooltipContent>
                          </Tooltip>
                        </TooltipProvider>
                      </div>
                  ...
                  <Slider onValueChange={handleChangeExistingProjects} value={[avgExistingProjects]} max={10000} min={1} step={1} />
                </div>
              </div>
